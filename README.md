...
**Difficulty:** 9/10 &middot; **Task type:** CV object detection (medical)
...
```bash
git clone https://github.com/Sandyyy123/liora-15-rsna-pneumonia.git
cd liora-15-rsna-pneumonia
